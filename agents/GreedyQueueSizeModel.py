...
class GreedyQueueSizeModel:
    ...
    def predict_one(self, state):
        ...
        In this case, chooses the action corresponding to the edge with 
        the queue containing the biggest number of cars
        """
        action = self._tlc._get_greedy_queue_length_action()
        return action
