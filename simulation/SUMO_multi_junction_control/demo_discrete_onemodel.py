...
if __name__ == '__main__':
    ...
    env = SumoEnvironmentDiscrete('SingleJunction/SingleJunction.rou.xml')
    ...
    policy_net = DQN_Linear(n_obs, n_actions)
    # load_path = 'saved_models/DQN_Grid3by3/DiscreteRL_OneModel_policy_net_flow_timevariant.pt'
    ...
    for e in range(5):
        ...
        for t in range(args.episode_length):
            ...
            for junction_id in range(num_junctions):
                ...
                Q_values = policy_net(obs_junction_tensor)
        ...
        print(traffic_load)
        x = np.linspace(0, len(traffic_load), len(traffic_load))
        print('Average traffic load: {}'.format(traffic_load.mean()))
